        ...
        <div className="bg-gray-100 py-24 sm:py-32">
            <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
                <div className="max-w-2xl">
                    <h2 className="text-3xl font-bold  text-gray-900 sm:text-4xl text-center font-roboto ">Nuestro Blog</h2>
                    <p className="mt-6 text-lg leading-8 text-gray-600 font-roboto ">
